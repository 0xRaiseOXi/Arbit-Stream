...
async def loading_data_index():
    ...
    while True:
        ...
        if flag == 1:
            ...
            list_index = [load_binance, load_kucoin, load_okx, load_huobi, load_bybit, load_bybit, load_bitfinex, load_gateio]
            tasks = []
...
def symbols():  
    ...
    for key, symbols in symbols_all.items():
        ...
        for exchange in new_list_data:
            symbols_list = {}
            settings_exchange = exchange['exchange'] + '_withdraw'
        ...
        if symbols_list_exchange:
            ...
            for exchange_key, symbols_key in symbols_list_exchange.items():
                # print(exchange_key, symbols_key)
                if symbols_key:    
